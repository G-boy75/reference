...
// package so it is sage to use with things like remember tokens.
...
// NBytes returns the number of bytes used i the base64
// URL encoded string
...
// remember tokens of a pretermined byte size.
